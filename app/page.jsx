  ...
  return (
    <div className="flex flex-col justify-between">
      ...
      <button
        ...
        className="mt-6 px-6 py-3 mb-8 bg-gradient-to-r from-blue-500 to-purple-500 text-white shadow-lg transition-all duration-300 ease-in-out hover:shadow-xl hover:from-blue-600 hover:to-purple-600 hover:scale-105 rounded-md hover:bg-accent transition-colors font-medium mx-auto"
      >
        Predictor
      </button>
      <footer className="">
